...
public interface NodeSelectionKeyAsyncCommands<K, V> {
     ...
     * @since 6.2
     */
    AsyncExecutions<Boolean> expire(K key, long seconds, ExpireArgs expireArgs);
     ...
     * @param pattern the pattern type: patternkey (pattern).
     * @return List&lt;K&gt; array-reply list of keys matching {@code pattern}.
     * @deprecated since 7.0, use {@link NodeSelectionKeyAsyncCommands#keys(String)}
     */
     ...
     * @param pattern the pattern.
     * @return Long array-reply list of keys matching {@code pattern}.
     * @deprecated since 7.0, use {@link NodeSelectionKeyAsyncCommands#keys(KeyStreamingChannel, String)}
     */
     ...
     * @since 6.2
     */
    AsyncExecutions<Boolean> pexpire(K key, long milliseconds, ExpireArgs expireArgs);
     ...
     * @since 6.2
     */
    AsyncExecutions<Boolean> pexpire(K key, Duration milliseconds, ExpireArgs expireArgs);
     ...
     *         does not exist.
     */
    AsyncExecutions<Long> pttl(K key);
     ...
     * @since 5.1
     */
    AsyncExecutions<String> restore(K key, byte[] value, RestoreArgs args);
